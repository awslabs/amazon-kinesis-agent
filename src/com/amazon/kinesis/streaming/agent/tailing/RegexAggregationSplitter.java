...
public class RegexAggregationSplitter implements ISplitter {
    /**
    ...
    public RegexAggregationSplitter(String startingPattern,final int recordSizeHint) {
            ...
            if (buffer.get() == SingleLineSplitter.LINE_DELIMITER) {
                ...
                if (!firstLine) {
                    ...
                    if(matcher.lookingAt()) {
                        ...
                        if (buffer.position() - initialPosition > recordSizeHint) {
                            //reached the sizeHint
